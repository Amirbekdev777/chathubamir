...
const loadSavedChatHistory = () => {
    ...
    savedConversations.forEach((conversation) => {
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="ai_logo_remove_background-removebg-preview.png" alt="Gemini avatar">
...
const handleOutgoingMessage = () => {
    ...
    const outgoingMessageHtml = `
        ...
        <div class="message__content">
            <img class="message__avatar" src="https://cdn-icons-png.flaticon.com/512/6596/6596121.png" alt="User avatar">
            <p class="message__text"></p>
        </div>
